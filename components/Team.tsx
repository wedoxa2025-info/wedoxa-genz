...
const members: TeamMember[] = [
  ...
  },
  {
    ...
    university: 'Sri Lanka Institute of Information Technology (SLIIT)',
    imageUrl: '/affath.jpeg',
    bio: 'SLIIT student with expertise in building scalable full stack applications. Passionate about creating seamless user experiences backed by robust server-side architecture.'
  },
  {
    id: '4',
    name: 'Farthaas',
    role: 'Full Stack Engineer',
    university: 'Sri Lanka Institute of Information Technology (SLIIT)',
    imageUrl: '/farthaas.jpg',
    bio: 'SLIIT developer dedicated to modern web technologies and best practices. Skilled in crafting efficient solutions that bridge frontend and backend ecosystems.'
  },
  {
    id: '5',
    name: 'Saathir',
    role: 'Designer',
    university: 'BECAS',
    imageUrl: '/saathir.jpeg',
    bio: 'Creative designer from BECAS bringing visual excellence and user-centered design principles to every project. Focused on creating intuitive and beautiful digital experiences.'
  }
];
